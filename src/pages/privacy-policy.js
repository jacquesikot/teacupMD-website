...
export default function IndexPage() {
  return (
    <ThemeProvider theme={theme}>
      ...
      <p>
        Medrite Pharmacy Limited built the Teacup MD app as a Freemium app. This
        SERVICE is provided by Medrite Pharmacy Limited at no cost and is
      ...
      <p>
        ...
        Terms and Conditions, which is accessible at Teacup MD unless otherwise
      ...
      <p>
        ...
        but not limited to email, fullname, phone number, address. The
      ...
      <p>This policy is effective as of 2021-06-22</p>{' '}
      <p>
        <strong>Contact Us</strong>
      </p>{' '}
      <p>
        If you have any questions or suggestions about our Privacy Policy, do
        not hesitate to contact us at No 2B Chilekwa Mwamba Road Lusaka.
      </p>
    </ThemeProvider>
  );
}
